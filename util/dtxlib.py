...
from util.bpylist.bplistlib._types import NSUUID
...
if __name__ == '__main__':
    ...
    # buf = b'y[=\x1f \x00\x00\x00\x00\x00\x01\x00r\x01\x00\x00\x03\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x01\x00\x00\x00\x02\x00\x00\x00\xa7\x00\x00\x00b\x01\x00\x00\x00\x00\x00\x00\xf0\x01\x00\x00\x00\x00\x00\x00\x97\x00\x00\x00\x00\x00\x00\x00\n\x00\x00\x00\x02\x00\x00\x00\x8b\x00\x00\x00bplist00\xd4\x01\x02\x03\x04\x05\x06\t\x0cY$archiverX$objectsT$topX$version_\x10\x0fNSKeyedArchiver\xa2\x07\x08U$null\x10\x1d\xd1\n\x0bTroot\x80\x01\x12\x00\x01\x86\xa0\x08\x11\x1b$)2DGMORWY\x00\x00\x00\x00\x00\x00\x01\x01\x00\x00\x00\x00\x00\x00\x00\r\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00^bplist00\xd4\x01\x02\x03\x04\x05\x06\t\x0cY$archiverX$objectsT$topX$version_\x10\x0fNSKeyedArchiver\xa2\x07\x08U$null_\x10/_IDE_initiateControlSessionWithProtocolVersion:\xd1\n\x0bTroot\x80\x01\x12\x00\x01\x86\xa0\x08\x11\x1b$)2DGM\x7f\x82\x87\x89\x00\x00\x00\x00\x00\x00\x01\x01\x00\x00\x00\x00\x00\x00\x00\r\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x8e'
    # p = DTXMessage.from_bytes(buf)
    # print(load(p.get_selector()))
    # print('解析成', b''.join(p._auxiliaries))
    #
    # for i in p._auxiliaries:
    #     print(auxiliary_to_pyobject(i))
    #
    #
    #
    # buf = b'y[=\x1f \x00\x00\x00\x00\x00\x01\x00s\x01\x00\x00\x03\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x01\x00\x00\x00\x02\x00\x00\x00\xa8\x00\x00\x00c\x01\x00\x00\x00\x00\x00\x00\xf0\x01\x00\x00\x00\x00\x00\x00\x98\x00\x00\x00\x00\x00\x00\x00\n\x00\x00\x00\x02\x00\x00\x00\x8c\x00\x00\x00bplist00\xd4\x01\x02\x03\x04\x05\x06\x07\nY$archiverX$versionX$objectsT$top_\x10\x0fNSKeyedArchiver\x12\x00\x01\x86\xa0\xa2\x08\tU$nullR29\xd1\x0b\x0cTroot\x80\x01\x08\x11\x1b$-2DILRUX]\x00\x00\x00\x00\x00\x00\x01\x01\x00\x00\x00\x00\x00\x00\x00\r\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00_bplist00\xd4\x01\x02\x03\x04\x05\x06\x07\nY$archiverX$versionX$objectsT$top_\x10\x0fNSKeyedArchiver\x12\x00\x01\x86\xa0\xa2\x08\tU$null_\x10/_IDE_initiateControlSessionWithProtocolVersion:\xd1\x0b\x0cTroot\x80\x01\x08\x11\x1b$-2DILR\x84\x87\x8c\x00\x00\x00\x00\x00\x00\x01\x01\x00\x00\x00\x00\x00\x00\x00\r\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x8e'
    # p = DTXMessage.from_bytes(buf)
    # print(load(p.get_selector()))
    # print('解析成', b''.join(p._auxiliaries))
    # for i in p._auxiliaries:
