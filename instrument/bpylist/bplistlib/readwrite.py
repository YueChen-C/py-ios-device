...
if __name__ == '__main__':
    buf = b'bplist00\xd4\x01\x02\x03\x04\x05\x06\x07\nY$archiverX$versionX$objectsT$top_\x10\x0fNSKeyedArchiver\x12\x00\x01\x86\xa0\xa2\x08\tU$null_\x10\x1a[PerfCat] Connection Lost!\xd1\x0b\x0cTroot\x80\x01\x08\x11\x1b$-2DILRorw\x00\x00\x00\x00\x00\x00\x01\x01\x00\x00\x00\x00\x00\x00\x00\r\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00y'
    print(buf)
    c = load(buf)
    print(c)
    print(c.get('$version'))
